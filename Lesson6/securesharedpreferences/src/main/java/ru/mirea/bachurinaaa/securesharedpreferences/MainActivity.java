...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.lermontov);
        ImageView.setImageBitmap(bitmap);
    }
}

//  /data/data/ru.mirea.bachurinaaa.securesharedpreferences/shared_prefs/secret_shared_prefs.xml