            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БИСО-03-19, НОМЕР ПО СПИСКУ: 24, МОЙ ЛЮБИМЫЙ ФИЛЬМ: 'Разлом Сан-Андреас'");
                        ...
                        Log.d("ThreadProject", String.format("Запущен поток № %d студентом группы № %s номер по списку № %d ", numberThread, "БИСО-03-19", 24));
